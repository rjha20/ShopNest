        ...
        <div className="min-h-screen mx-4 sm:mx-6 text-slate-800">
            ...
            <div className="max-w-7xl mx-auto ">
                ...
                <div className="flex items-start justify-between gap-5 max-lg:flex-col">
                    ...
                    <table className="w-full min-w-[620px] text-slate-600 table-auto">
                        <thead>
                        ...
                        <tbody>
                            {
                                cartArray.map((item, index) => (
                                    <tr key={index} className="space-x-2">
                                        <td className="flex gap-3 my-4 min-w-[260px]">
                                            <div className="flex gap-3 items-center justify-center bg-slate-100 w-16 h-16 rounded-md">
