...
export default function Banner() {
    ...
    return isOpen && (
        <div className="w-full px-4 sm:px-6 py-2 sm:py-1 font-medium text-xs sm:text-sm text-white text-center bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A]">
            <div className='flex items-center justify-between gap-3 max-w-7xl mx-auto'>
                <p className="text-left sm:text-center">Get 20% OFF on Your First Order!</p>
